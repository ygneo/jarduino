...
const int minSensorValue[] = {90, 50}; // Array of minimun values from the potentiometer to trigger watering
...
const long int wateringTime[] = {5000, 10000}; // Watering time in ms for every plant
