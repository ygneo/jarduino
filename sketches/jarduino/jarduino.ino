...
const int minSensorValue[] = {600, 400}; // Array of minimun values from the potentiometer to trigger watering
...
const int wateringTime[] = {240000, 120000}; // Watering time in ms for every plant
